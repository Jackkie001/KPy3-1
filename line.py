...
#--------------------------------------------------------------------
        if op.type == 26:
            ...
            if msg.contentType == 16:
                ...
                cl.likePost(url[25:58], url[66:], likeType=1002)
...
#------------------------------------------------------------------------------
                ...
                if wait["autoBlock"] == True:
                    cl.sendMessage(msg.to,"เปิดการบล็อคเพื่อนเรียบร้อย(｀・ω・´)")

            elif msg.text.lower() == ".autoblock off":
                if wait["autoBlock"] == False:
                    cl.sendMessage(msg.to,"ปิดการบล็อคเพื่อนเรียบร้อย(｀・ω・´)")
...
#--------------------------------------------------------------------
                ...
                cxz = cl.getGroup(msg.to).members
                zxc = cl.getProfile().mid
                cl.inviteIntoGroupCall(msg.to,[uid.mid for uid in cxz if uid.mid != zxc])
...
#-----------------------------------------------------------
                ...
                cl.sendMessage(msg.to,"ทำการลบแชทบอทเรียบร้อย (｀・ω・´)")
#-----------------------------------------------------------
